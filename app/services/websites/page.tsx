...
export const metadata: Metadata = {
  ...
  description:
    "Functional websites that act as part of your business system—clear messaging, lead capture, integrations, and mobile-first performance.",
...
export default function WebsitesThatSupportBusinessPage() {
  // ✅ EXACT CONTENT (Service 3)
  const problemBullets = ["Look fine", "Say a lot", "Do very little"];

  const buildBullets = [
    "Clear messaging for customers",
    "Lead capture that feeds your systems",
    "Integration with WhatsApp, email, CRM",
    "Mobile-first performance",
  ];

  const changeBullets = [
    { icon: ClipboardCheck, title: "Better quality enquiries" },
    { icon: LayoutDashboard, title: "Faster response times" },
    { icon: PlugZap, title: "Less manual handling" },
    { icon: Workflow, title: "A website that earns its keep" },
  ];

  // Keep same process layout (4 cards on right) — using ONLY your “What We Build” items (no new copy)
  const steps = [
    { n: "01", title: "What We Build", desc: "Clear messaging for customers" },
    { n: "02", title: "What We Build", desc: "Lead capture that feeds your systems" },
    { n: "03", title: "What We Build", desc: "Integration with WhatsApp, email, CRM" },
    { n: "04", title: "What We Build", desc: "Mobile-first performance" },
  ];
  ...
  return (
    <main className="bg-white text-slate-900">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-16 md:pt-20 pb-16 md:pb-20 text-center">
          <h1 className="text-4xl md:text-6xl font-semibold tracking-tight text-slate-900">
            Websites That Support the Business (Not Just Marketing)
          </h1>
      ...
      <section className="bg-white">
        <Container>
          <div className="py-14 md:py-20 grid gap-12 lg:grid-cols-12 items-center">
              ...
              <div className="relative">
                ...
                <div className="relative overflow-hidden rounded-[28px] border border-slate-200 bg-slate-100 shadow-sm">
                  <Image
                    ...
                    alt="Websites that support the business"
                    width={1600}
                    height={1100}
                    unoptimized
            ...
            {/* Content */}
            <div className="lg:col-span-6">
              <OrangePill>SERVICE 3</OrangePill>
              ...
              <p className="mt-2 text-slate-600">Many websites:</p>
              ...
              <p className="mt-5 text-slate-600">
                They don’t connect to sales, operations, or follow-up.
              </p>
      ...
      {/* SECTION 2 — Process (same design + your "What We Build" content) */}
            ...
            <div className="lg:col-span-5">
              ...
              <div className="mt-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <p className="mt-3 text-slate-600 leading-relaxed">
                  We build functional websites that act as part of your business system.
                </p>
            ...
            <div className="lg:col-span-7">
              <div className="relative overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm">
                <Image
                  ...
                  alt="Website strategy and build"
                  width={1600}
                  height={1100}
                  unoptimized
