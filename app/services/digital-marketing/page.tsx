...
export const metadata: Metadata = {
  ...
  description:
    "Measurable marketing with clear objectives, lead tracking, conversion visibility, and simple performance reporting.",
...
export default function DigitalMarketingWithAccountabilityPage() {
  // ✅ EXACT CONTENT
  const problemBullets = ["Money is spent", "Activity happens", "Results are unclear"];

  const deliverBullets = [
    "Campaign setup with clear objectives",
  ...
  const changeBullets = [
    { icon: ClipboardCheck, title: "Clear understanding of ROI" },
    { icon: LayoutDashboard, title: "Confidence in decisions" },
    { icon: PlugZap, title: "Ability to scale what works" },
    { icon: LineChart, title: "No more blind spending" },
  ];

  // Keep same right-side 4 cards (use ONLY your deliver bullets — no new copy)
  const steps = [
    { n: "01", title: "What We Deliver", desc: "Campaign setup with clear objectives" },
    { n: "02", title: "What We Deliver", desc: "Lead tracking and attribution" },
    { n: "03", title: "What We Deliver", desc: "Conversion visibility" },
    { n: "04", title: "What We Deliver", desc: "Simple performance reporting" },
  ];
  ...
  return (
    <main className="bg-white text-slate-900">
        ...
        <Container>
          <div className="py-14 md:py-20 grid gap-12 lg:grid-cols-12 items-center">
              ...
              <div className="relative">
                ...
                <div className="relative overflow-hidden rounded-[28px] border border-slate-200 bg-slate-100 shadow-sm">
                  <Image
                    ...
                    alt="Digital marketing with accountability"
                    width={1600}
                    height={1100}
                    unoptimized
            ...
            <div className="lg:col-span-6">
              ...
              <p className="mt-2 text-slate-600">Most business owners are frustrated because:</p>
      ...
      {/* SECTION 2 — Process (same design + your "What We Deliver" content) */}
          ...
          <div className="py-14 md:py-20 grid gap-12 lg:grid-cols-12 items-start">
            ...
            <div className="lg:col-span-5">
              ...
              <div className="mt-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                <p className="text-sm font-semibold text-slate-900">What We Deliver</p>
                <p className="mt-3 text-slate-600 leading-relaxed">
                  We focus on measurable marketing, not vanity metrics.
                </p>

                <p className="mt-5 text-slate-600">This includes:</p>

                <div className="mt-4 grid gap-3 sm:grid-cols-2">
                  {deliverBullets.map((t) => (
                    <Chip key={t}>{t}</Chip>
                  ))}
                </div>
              </div>
