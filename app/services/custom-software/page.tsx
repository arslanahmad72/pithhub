...
export const metadata: Metadata = {
  title: "Custom Software (Web & Mobile) | PithHub (Jamaica)",
  description:
    "Custom Software (Web & Mobile). We build custom software designed specifically around your operations.",
...
export default function CustomSoftwareServicePage() {
  // ✅ EXACT CONTENT (Service 2)
  const problemBullets = [
    "Forces you to change how you work",
    "Includes features you don’t need",
    "Still doesn’t solve your real issues",
  ];

  const buildBullets = [
    "Web-based systems",
    "Mobile-friendly tools",
    "Simple interfaces for staff",
    "Secure, scalable architecture",
  ];

  const changeBullets = [
    { icon: ClipboardCheck, title: "Tools that actually fit" },
    { icon: LayoutDashboard, title: "Faster adoption by staff" },
    { icon: PlugZap, title: "Systems that grow with the business" },
    { icon: ShieldCheck, title: "No workarounds or duct tape" },
  ];

  // Keep same process layout (4 cards on right)
  const steps = [
    { n: "01", title: "Custom Software", desc: "Web-based systems" },
    { n: "02", title: "Custom Software", desc: "Mobile-friendly tools" },
    { n: "03", title: "Custom Software", desc: "Simple interfaces for staff" },
    { n: "04", title: "Custom Software", desc: "Secure, scalable architecture" },
  ];
      ...
      <section className="bg-white">
        <Container>
          <div className="py-14 md:py-20 grid gap-12 lg:grid-cols-12 items-center">
            ...
            {/* Content */}
            <div className="lg:col-span-6">
              <OrangePill>SERVICE 2</OrangePill>
              ...
              <p className="mt-2 text-slate-600">Off-the-shelf software often:</p>
            ...
            <div className="lg:col-span-5">
              ...
              <div className="mt-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <p className="mt-3 text-slate-600 leading-relaxed">
                  We build custom software designed specifically around your operations.
                </p>
