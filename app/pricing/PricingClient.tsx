...
const tiers = [
  ...
  },
  {
    ...
    bestFor: ["Growing teams", "Businesses adding staff", "Owners feeling stretched"],
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-20 pb-24 text-center">
          <motion.div initial="hidden" animate="show" variants={stagger}>
            ...
            <motion.div variants={fadeUp} className="mt-4 text-sm text-slate-500">
              ...
              <span className="text-[var(--brand-orange)] font-medium">Pricing</span>
            </motion.div>
      ...
      <section className="relative overflow-hidden bg-white py-20">
        <Container>
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.55, ease: EASE }} // ✅ fixed
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0">
          <div className="text-xs font-semibold tracking-wide text-slate-500">{tier.name}</div>
